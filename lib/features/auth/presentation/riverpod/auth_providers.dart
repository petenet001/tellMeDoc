...
import 'package:tell_me_doctor/features/auth/domain/usecases/sign_in_with_google_usecase.dart';
...
final signInWithGoogleUseCaseProvider = Provider((ref) => SignInWithGoogleUseCase(ref.watch(authRepositoryProvider)));
