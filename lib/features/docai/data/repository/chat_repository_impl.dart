...
class ChatRepositoryImpl implements ChatRepository {
  ...
  Future<ChatMessage> sendTextMessage(String content) async {
    try {
      final userMessage = ChatMessage(content: content, type: MessageType.user, contentType: ContentType.text);
      _messages.add(userMessage);

      final aiResponse = await remoteDataSource.generateTextResponse(content);
